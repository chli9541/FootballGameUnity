...
public class PlayerEvaluater : MonoBehaviour {
    ...
    /// <param name="p"></param>
    /// <returns></returns>
    public static float EvaluatePlayer(Player p)
    {
        if (p.position == "前腰")
            return EvaluateAM(p);
    ...
    public static float EvaluateCM(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateAM(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateST(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateCF(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateWF(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateWM(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateFB(Player p)
    {
        float eval = 0;
    ...
    public static float EvaluateCB(Player p)
    {
        float eval = 0;
